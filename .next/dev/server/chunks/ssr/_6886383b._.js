...
"[project]/entities/offer/types.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/entities/offer/repo.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/entities/offer/types.ts [app-rsc] (ecmascript)");
;
async function createOffer(supabase, data) {
    ...
    if (error) throw error;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["offerFromRow"])(row);
}
async function getOfferById(supabase, offerId) {
    const { data: row, error } = await supabase.from('offers').select('*').eq('id', offerId).is('deleted_at', null).single();
    if (error) {
        if (error.code === 'PGRST116') return null;
        throw error;
    }
...
async function getMyOfferForRFQ(supabase, rfqId, companyId) {
    const { data: row, error } = await supabase.from('offers').select('*').eq('rfq_id', rfqId).eq('company_id', companyId).is('deleted_at', null).single();
    if (error) {
        if (error.code === 'PGRST116') return null;
        throw error;
    }
...
async function listOffersForRFQ(supabase, rfqId) {
    const { data: rows, error } = await supabase.from('offers').select(`
      *,
      company:companies(id, name, location, contact_phone, contact_email, contact_person)
    `).eq('rfq_id', rfqId).is('deleted_at', null).order('created_at', {
        ascending: true
    });
    if (error) throw error;
    return (rows || []).map((row)=>{
        const offer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["offerFromRow"])(row);
        const companyData = row.company;
        return {
            ...offer,
            company: {
...
async function updateOffer(supabase, offerId, data) {
    const updateData = {};
    if (data.price !== undefined) updateData.price = data.price;
    if (data.currency !== undefined) updateData.currency = data.currency;
    if (data.deliveryDays !== undefined) updateData.delivery_days = data.deliveryDays;
    if (data.notes !== undefined) updateData.notes = data.notes;
    const { data: row, error } = await supabase.from('offers').update(updateData).eq('id', offerId).select().single();
    if (error) throw error;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["offerFromRow"])(row);
}
async function upsertOffer(supabase, data) {
...
async function selectWinningOffer(supabase, offerId) {
    ...
    await supabase.from('offers').update({
        is_selected: false
    }).eq('rfq_id', offer.rfqId).eq('is_selected', true);
    // Select the new winner
    const { data: row, error } = await supabase.from('offers').update({
        is_selected: true
    }).eq('id', offerId).select().single();
    if (error) throw error;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$types$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["offerFromRow"])(row);
}
async function deselectOffer(supabase, offerId) {
    const { data: row, error } = await supabase.from('offers').update({
        is_selected: false
    }).eq('id', offerId).select().single();
    if (error) throw error;
...
async function softDeleteOffer(supabase, offerId) {
    const { error } = await supabase.from('offers').update({
        deleted_at: new Date().toISOString()
    }).eq('id', offerId);
    if (error) throw error;
}
async function countOffersForRFQ(supabase, rfqId) {
    const { count, error } = await supabase.from('offers').select('*', {
        count: 'exact',
        head: true
    }).eq('rfq_id', rfqId).is('deleted_at', null);
    if (error) throw error;
    return count || 0;
}
async function getMyOfferedRFQIds(supabase, companyId) {
    const { data, error } = await supabase.from('offers').select('rfq_id').eq('company_id', companyId).is('deleted_at', null);
    if (error) throw error;
    return (data || []).map((row)=>row.rfq_id);
}
}),
"[project]/features/offer/services/offer-service.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"4034d6b9e2f5224702068baa39e92af3759c23a8b2":"submitOfferAction","4089b3b653213b0dacb9eacac97bdaa23804c27198":"getOffersForRFQAction","40e2dd3dc830902c2fdbdf7c2aca9678b0d33269cf":"getMyOfferedRFQIdsAction","60d08f49ae36199f6051b8fa04ff86eb188ed97fa6":"getMyOfferAction","7049991a826d2841c1ca1a6d08a7052e39dbf1973a":"selectWinnerAction"},"",""] */ __turbopack_context__.s([
    "getMyOfferAction",
    ()=>getMyOfferAction,
...
;
;
async function submitOfferAction(data) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        const offer = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["upsertOffer"])(supabase, data);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/rfqs/${data.rfqId}`);
        return {
            offer
        };
    } catch (error) {
...
async function selectWinnerAction(offerId, rfqId, completeRFQ = false) {
    try {
        const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["selectWinningOffer"])(supabase, offerId);
        if (completeRFQ) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$rfq$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updateRFQStatus"])(supabase, rfqId, 'completed');
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/rfqs/${rfqId}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])('/my-rfqs');
        return {
...
async function getOffersForRFQAction(rfqId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["listOffersForRFQ"])(supabase, rfqId);
}
async function getMyOfferAction(rfqId, companyId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMyOfferForRFQ"])(supabase, rfqId, companyId);
}
async function getMyOfferedRFQIdsAction(companyId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$shared$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$entities$2f$offer$2f$repo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMyOfferedRFQIds"])(supabase, companyId);
}
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
    submitOfferAction,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(submitOfferAction, "4034d6b9e2f5224702068baa39e92af3759c23a8b2", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(selectWinnerAction, "7049991a826d2841c1ca1a6d08a7052e39dbf1973a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getOffersForRFQAction, "4089b3b653213b0dacb9eacac97bdaa23804c27198", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getMyOfferAction, "60d08f49ae36199f6051b8fa04ff86eb188ed97fa6", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getMyOfferedRFQIdsAction, "40e2dd3dc830902c2fdbdf7c2aca9678b0d33269cf", null);
}),
"[project]/.next-internal/server/app/(dashboard)/rfqs/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/features/auth/services/auth-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/features/notification/services/notification-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/features/rfq/services/file-service.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/features/rfq/services/rfq-service.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/features/offer/services/offer-service.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/offer/services/offer-service.ts [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/.next-internal/server/app/(dashboard)/rfqs/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/features/auth/services/auth-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/features/notification/services/notification-actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/features/rfq/services/file-service.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/features/rfq/services/rfq-service.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE4 => \"[project]/features/offer/services/offer-service.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "4029aca26fb6205270e4847cb7f5bf580062162bea",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$rfq$2f$services$2f$file$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSignedDownloadUrlAction"],
    "4034d6b9e2f5224702068baa39e92af3759c23a8b2",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["submitOfferAction"],
    "4089b3b653213b0dacb9eacac97bdaa23804c27198",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getOffersForRFQAction"],
    ...
    "40e2dd3dc830902c2fdbdf7c2aca9678b0d33269cf",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMyOfferedRFQIdsAction"],
    ...
    "60d08f49ae36199f6051b8fa04ff86eb188ed97fa6",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getMyOfferAction"],
    "7049991a826d2841c1ca1a6d08a7052e39dbf1973a",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["selectWinnerAction"],
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$dashboard$292f$rfqs$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$features$2f$auth$2f$services$2f$auth$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$features$2f$notification$2f$services$2f$notification$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$features$2f$rfq$2f$services$2f$file$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$features$2f$rfq$2f$services$2f$rfq$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE4__$3d3e$__$225b$project$5d2f$features$2f$offer$2f$services$2f$offer$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/(dashboard)/rfqs/[id]/page/actions.js { ACTIONS_MODULE0 => "[project]/features/auth/services/auth-actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/features/notification/services/notification-actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/features/rfq/services/file-service.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/features/rfq/services/rfq-service.ts [app-rsc] (ecmascript)", ACTIONS_MODULE4 => "[project]/features/offer/services/offer-service.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$auth$2f$services$2f$auth$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/auth/services/auth-actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$notification$2f$services$2f$notification$2d$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/notification/services/notification-actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$rfq$2f$services$2f$file$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/rfq/services/file-service.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$features$2f$rfq$2f$services$2f$rfq$2d$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/features/rfq/services/rfq-service.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=_6886383b._.js.map