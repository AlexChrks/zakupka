...
import { Calendar, MapPin, Package, DollarSign, CheckCircle2, Trophy } from 'lucide-react'
...
export const RFQCard = forwardRef<HTMLDivElement, RFQCardProps>(
  function RFQCard({ rfq, showCompany = true, hasMyOffer = false, isHighlighted = false, isWon = false }, ref) {
    ...
    return (
      <Card
        ...
        className={cn(
          ...
          hasMyOffer && !isWon && 'ring-2 ring-yellow-500/20 bg-yellow-50/30 dark:bg-yellow-950/10',
          isWon && 'ring-2 ring-green-500 bg-green-50/50 dark:bg-green-950/20',
        ...
        <CardHeader className="pb-3">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              {hasMyOffer && !isWon && (
                <Badge variant="default" size="responsive" className="bg-yellow-500 hover:bg-yellow-600 text-yellow-950">
